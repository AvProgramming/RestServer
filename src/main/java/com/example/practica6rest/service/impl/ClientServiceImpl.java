...
public class ClientServiceImpl implements ClientService {
  ...
  @Override
  public ClientDto updateAddress(ClientDto newClient, Long id) {
  ...
  @Override
  public ClientDto updatePhone(ClientDto newClient, Long id) {
  ...
  @Override
  public ClientDto updateEmail(ClientDto newClient, Long id) {
